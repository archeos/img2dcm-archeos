...
class DicomWriter:
    ...
    def __init__(self):
        ...
        #self.new_dicom .SetFileDimensionality()
    ...
    def SetStudyID(self, sid):
        self.anony.Replace(gdcm.Tag(0x0020,0x0010), \
                           str(sid))
    ...
    def SetPatientID(self, pid):
        self.anony.Replace(gdcm.Tag(0x0010,0x0020), \
                str(pid))
    ...
    def SetPixelSpacing(self, spacing):
        """
        Set pixel spacing x and y, requeries 
